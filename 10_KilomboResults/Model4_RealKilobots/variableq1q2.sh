  ...
  do
    ...
    do
      ...
      do
        ...
        sed -i '' "s/bees.json/bees_model=4_N=$ndig-deltat=$tdig-lambda=$l-q1=$q1dig-q2=$q2dig-p1=$p1-p2=$p2dig-t=$simtime-seed=$seed-indseed=$ind_seed-rep=$kdig-speed=9.json/g" kilombo.json
        ...
        sed -i '' "s/bees_model=4_N=$ndig-deltat=$tdig-lambda=$l-q1=$q1dig-q2=$q2dig-p1=$p1-p2=$p2dig-t=$simtime-seed=$seed-indseed=$ind_seed-rep=$kdig-speed=9.json/bees.json/g" kilombo.json
