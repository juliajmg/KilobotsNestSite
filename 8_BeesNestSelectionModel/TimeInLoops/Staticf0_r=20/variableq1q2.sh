  ...
  do
    ...
    do
      ...
      do
        ...
        sed -i "s/\EXECUTABLE=.*/\  EXECUTABLE=bees_model=2_InitCycle=30_t=loop_deltat=$t-q1=$q1dig-q2=$q2dig-p1=$p1-p2=$p2-lambda=$l-color=RGB_static=all_beacons=2/g" Makefile
        #  make #
        make hex
